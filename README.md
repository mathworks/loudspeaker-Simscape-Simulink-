...
speaker\_both.slx -- model showing both the Simulink® and the Simscape™ implementation.
speaker\_simscape.slx -- model implemented in Simscape only
speaker\_simulink.slx -- model implemented in Simulink only
